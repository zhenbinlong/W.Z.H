...
<div class="uc_mainnr">
    <h3 class="uc_miantit">
        <form action="/order/list" method="post" enctype="application/x-www-form-urlencoded">
            <input class="validationBinded" name="_token" value="{{ csrf_token()}}" type="hidden">                    <span>我的订单</span>
    ...
    <div class="uc_nrlist">
        ...
        <div class="user_visa_order ST M_bt20 order_box">
            ...
            <div class="box Mbot20">
                ...
                <div class="hd">
                    <ul>
                        <li style="float:left">订单号：{{$data->line_id}}&nbsp;&nbsp;&nbsp;</li> 
                        <li style="float:left">成交时间：{{ $data->addtime}}</li>
                    ...
                    <table border="1" cellpadding="0" cellspacing="0" align="center" width="820">
                        ...
                        <tbody>
                            <tr>
                                    ...
                                    <ul>
                                        <li class="tit">
                                            ...
                                            <a class="title_1837317" href="" target="_blank"> <img src="/tw_80x60.jpg" width="50">
                                                <span class="text  YH">{{ $data->line_name}}</span></a>
                                        </li>
                                    </ul>
                                </td>
                                <td class="bor wc" align="center" valign="middle" width="120">{{ $data->status}}                                     <br>
                                </td>

                                <td class="bor dd" data-order-sn="1837317"  align="center" valign="middle" width="120">                              {{ $data->line_pri}}
                                ...
                                <td rowspan="2" class="bor price" align="center" valign="middle" width="120"><span>¥{{ $data->total_pri}}</span><br>
